...
public class AfferentCoupling_Test {
	...
	public void testAfferentCoupling() {
		...
		try {
			...
			Double afferentValue = AfferentCoupling.run(packageClasses1);
			...
			assertEquals(3, afferentValue, 0.0);
		} catch (FileNotFoundException e) {
				System.out.println("Error loading classes in Afferent Coupling test");
		}
	}
}
